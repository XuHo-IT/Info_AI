    ...
    IVectorStore vectorStore)
{
    ...
    {
        var chunksCollection = vectorStore.GetCollection<string, IngestedChunk>("data-myaichatapp-chunks");
        var documentsCollection = vectorStore.GetCollection<string, IngestedDocument>("data-myaichatapp-documents");
